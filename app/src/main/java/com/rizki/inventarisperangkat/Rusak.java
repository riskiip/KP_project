...
public class Rusak extends AppCompatActivity {
    public static final String EXTRA_LVL_RUSAK = "com.rizki.inventarisperangkat.EXTRA_LVL_RUSAK";
    FloatingActionButton fabRusak;
    private static final String BASE_URL = "http://layanan.batan.go.id/mobilepjkkd/";
    private Rusak.ListViewAdapter adapter;
    private ListView mListView;
    TextView tvlvlHome;

    private void populateListView(List<Rusak.ModelData> perangkatLists) {
        mListView = findViewById(R.id.mListView);
        adapter = new Rusak.ListViewAdapter(this,perangkatLists);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabRusak = findViewById(R.id.fabHome);
        fabRusak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent tambah = new Intent(Rusak.this, AddActivity.class);
        ...
        String lvlHome = intent.getStringExtra(Perangkat.EXTRA_LVL5);
        ...
        Rusak.MyAPIService myAPIService = Rusak.RetrofitClientInstance.getRetrofitInstance().create(Rusak.MyAPIService.class);
        Call<List<Rusak.ModelData>> call = myAPIService.getData();
        call.enqueue(new Callback<List<Rusak.ModelData>>() {

            @Override
            public void onResponse(Call<List<Rusak.ModelData>> call, Response<List<Rusak.ModelData>> response) {
                myProgressBar.setVisibility(View.GONE);
                populateListView(response.body());
            }
            @Override
            public void onFailure(Call<List<Rusak.ModelData>> call, Throwable throwable) {
                myProgressBar.setVisibility(View.GONE);
                Toast.makeText(Rusak.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    interface MyAPIService {
        @GET("read_data_rusak.php")
        Call<List<Rusak.ModelData>> getData();
    }
    ...
    public class ListViewAdapter extends BaseAdapter implements Filterable {
        ...
        public List<Rusak.ModelData> dataPerangkat, dataFull;
        private Context context;

        public ListViewAdapter(Context context,List<Rusak.ModelData> dataPerangkat){
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final Rusak.ModelData Perangkats= dataPerangkat.get(position);
        ...
        private void openDetailActivity(String[] data) {
            String lvlRusak = tvlvlHome.getText().toString();
            Intent intent = new Intent(Rusak.this, DetailRusak.class);
            ...
            intent.putExtra(EXTRA_LVL_RUSAK, lvlRusak);
        ...
        private Filter perangkatFilter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                List<Rusak.ModelData> filteredList = new ArrayList<>();
                ...
                if(constraint == null || constraint.length() == 0){
                    ...
                    for(Rusak.ModelData item : dataFull){
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                dataPerangkat.clear();
                dataPerangkat.addAll((Collection<? extends Rusak.ModelData>) results.values);
