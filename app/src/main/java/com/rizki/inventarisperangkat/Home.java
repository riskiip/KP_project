...
public class Home extends AppCompatActivity {
    public static final String EXTRA_LVL_STOK = "com.rizki.inventarisperangkat.EXTRA_LVL_STOK";
    ...
    private void populateListView(List<ModelData> perangkatLists) {
        mListView = findViewById(R.id.mListView);
        adapter = new ListViewAdapter(this,perangkatLists);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent tambah = new Intent(Home.this, AddActivity.class);
        ...
        String lvlHome = intent.getStringExtra(Perangkat.EXTRA_LVL3);
        ...
        Call<List<ModelData>> call = myAPIService.getData();
        call.enqueue(new Callback<List<ModelData>>() {
            ...
            @Override
            public void onFailure(Call<List<ModelData>> call, Throwable throwable) {
                myProgressBar.setVisibility(View.GONE);
    ...
    public class ListViewAdapter extends BaseAdapter implements Filterable {
        ...
        public List<ModelData> dataPerangkat, dataFull;
        private Context context;

        public ListViewAdapter(Context context,List<ModelData> dataPerangkat){
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final ModelData Perangkats= dataPerangkat.get(position);
        ...
        private void openDetailActivity(String[] data) {
            String lvlStok = tvlvlHome.getText().toString();
            Intent intent = new Intent(Home.this, DetailStok.class);
            ...
            intent.putExtra(EXTRA_LVL_STOK, lvlStok);
        ...
        private Filter perangkatFilter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                dataPerangkat.clear();
                dataPerangkat.addAll((Collection<? extends ModelData>) results.values);
